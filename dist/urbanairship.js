(function() {
  var Api, DeviceApi, DevicesApi, Rest, UrbanAirship,
  ...
  Api = {
    ...
    Devices: DevicesApi = (function() {
      function DevicesApi(client, ids) {
        this.client = client;
        this.ids = ids;
      }

      DevicesApi.prototype.push = function(opts, cb) {
        return this.client.post('/api/push', {
          audience: {
            'or': this.ids.map(function(id) {
              return {
                device_token: id
              };
            })
  ...
  UrbanAirship = (function(_super) {
    ...
    UrbanAirship.prototype.devices = function(ids) {
      return new Api.Devices(this, ids);
    };
